...
function LandingPage({ level, restart,lost}) {
  if(!lost){
  return <div className='bg-black text-white w-screen h-screen flex flex-col justify-center items-center'>
    ...
    return <div className='bg-black text-white w-screen h-screen flex flex-col justify-center items-center'>
      ...
      <button className='bg-green-400 w-32 p-2 hover:bg-green-500 active:bg-green-600 focus:outline-none focus:ring focus:ring-green-500 rounded-xl'>Sure</button>
  </div>;
  }
}
